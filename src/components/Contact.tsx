      ...
      <div className="mx-auto max-w-6xl">
          ...
          {topCards.map((item) => {
            ...
            return (
              <a
                ...
                className="rounded-2xl border border-card-border bg-card p-8 text-center transition-colors hover:border-accent/50"
              >
                {content}
              </a>
            );
        ...
        <div className="mt-10 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-accent px-10 py-3.5 text-sm font-medium text-white transition-opacity hover:opacity-90"
          >
            <Mail size={18} />
            {contact.emailCta}
          </a>
